...
var _ QuestionRepository = (*questionRepository)(nil)

type questionRepository struct {
	db *gorm.DB
}

func NewQuestionRepository(db QuizzesDB) QuestionRepository {
	return &questionRepository{
		db: db,
	}
}

// FindByQuizID implements QuestionRepository
func (*questionRepository) FindByQuizID(ctx context.Context, quiz_id int64) ([]*domain.Question, error) {
	panic("unimplemented")
}

// Save implements QuestionRepository
func (*questionRepository) Save(ctx context.Context, question *domain.Question) error {
	panic("unimplemented")
}
