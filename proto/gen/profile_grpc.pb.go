...
func (c *profileServiceClient) Authorize(ctx context.Context, in *AuthorizeRequest, opts ...grpc.CallOption) (*AuthorizeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/go.todoapp.proto.profile.ProfileService/Authorize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/go.todoapp.proto.profile.ProfileService/GetProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProfileService_Authorize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.todoapp.proto.profile.ProfileService/Authorize",
	}
...
func _ProfileService_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.todoapp.proto.profile.ProfileService/GetProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "go.todoapp.proto.profile.ProfileService",
